...
import { addGame, cancelMatch, declareWinner, deleteGamesById, getAllGames, toggleBet, updateGamesById } from "../controller/gameController.js";
...
router.route('/cancel').patch(isAuthenticatedUser, authorizeRoles("admin"), cancelMatch);
